from .graphical_ops import (OpenDistributionOperator, SwitchLabelingTabOperator,
...
operators = (
    ...
    #
    ApplyLogPathOperator, OpenLogsOperator, SavePipelineAsOperator, LoadPipelineOperator, SwitchLabelingTabOperator,
